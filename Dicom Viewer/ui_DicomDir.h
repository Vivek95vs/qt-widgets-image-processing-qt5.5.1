...
public:
    ...
    {
        DicomDir->setWindowTitle(QApplication::translate("DicomDir", "\347\227\205\344\272\272\345\210\227\350\241\250", 0));
        ButtonOK->setText(QApplication::translate("DicomDir", "OK", 0));
        ButtonCancel->setText(QApplication::translate("DicomDir", "Cancel", 0));
    } // retranslateUi
