...
QT_MOC_LITERAL(3, 24, 6) // "doWork"

    },
    "MyWorker\0NumberChanged\0\0doWork"
};
...
void MyWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyWorker::NumberChanged)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MyWorker::NumberChanged(int _t1)
{
