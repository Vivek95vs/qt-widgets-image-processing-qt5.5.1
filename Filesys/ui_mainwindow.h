...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(1140, 792);
        centralWidget = new QWidget(MainWindow);
        centralWidget->setObjectName(QStringLiteral("centralWidget"));
        treeView = new QTreeView(centralWidget);
        treeView->setObjectName(QStringLiteral("treeView"));
        treeView->setGeometry(QRect(20, 30, 331, 701));
        listView2 = new QListView(centralWidget);
        listView2->setObjectName(QStringLiteral("listView2"));
        listView2->setGeometry(QRect(730, 30, 381, 701));
        listView1 = new QListView(centralWidget);
        listView1->setObjectName(QStringLiteral("listView1"));
        listView1->setGeometry(QRect(375, 30, 341, 701));
        label1 = new QLabel(centralWidget);
        label1->setObjectName(QStringLiteral("label1"));
        label1->setGeometry(QRect(110, 10, 151, 16));
        label2 = new QLabel(centralWidget);
        label2->setObjectName(QStringLiteral("label2"));
        label2->setGeometry(QRect(480, 10, 191, 16));
        label3 = new QLabel(centralWidget);
        label3->setObjectName(QStringLiteral("label3"));
        label3->setGeometry(QRect(830, 6, 211, 20));
