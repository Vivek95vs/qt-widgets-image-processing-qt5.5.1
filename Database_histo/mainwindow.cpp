...
//    QObject::connect(this,SIGNAL(databasesig(QString &arg1)),enhancer,SLOT(receivedatasig(QString &arg3)));
}
...
void MainWindow::on_combo1_currentIndexChanged(const QString &arg1)
{
    index= ui->combo1->currentText();
    qDebug()<<"CurrentVal"<<index;
//    emit databasesig(index);
}
