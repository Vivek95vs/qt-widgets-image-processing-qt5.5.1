...
public:
    ...
    QPushButton *sqlData;
    QPushButton *sqldata1;
    QPushButton *writedatabase;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        combo1->setGeometry(QRect(10, 40, 69, 22));
        combo1->setStyleSheet(QLatin1String("QComboBox {\n"
"         border: 0.5px solid rgb(10,182,242); /* border */\n"
"		border-top:none;\n"
"		border-left:none;\n"
"    background: transparent;\n"
"}\n"
" /* After the drop-down, the entire drop-down form style */\n"
"QComboBox QAbstractItemView {\n"
"         \n"
"         border: 0.5px solid white; /* The border of the entire drop-down form */\n"
"			border-top:none;\n"
"   		 color:white;\n"
"            background: transparent; /* The background color of the entire drop-down window */\n"
"         selection-background-color: rgb(10,182,242); /* The background color of the selected item in the entire drop-down window */\n"
"}"));
        ...
        sqlData = new QPushButton(layoutWidget);
        sqlData->setObjectName(QStringLiteral("sqlData"));

        horizontalLayout_5->addWidget(sqlData);

        sqldata1 = new QPushButton(layoutWidget);
        sqldata1->setObjectName(QStringLiteral("sqldata1"));

        horizontalLayout_5->addWidget(sqldata1);

        writedatabase = new QPushButton(layoutWidget);
        writedatabase->setObjectName(QStringLiteral("writedatabase"));

        horizontalLayout_5->addWidget(writedatabase);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        sqlData->setText(QApplication::translate("MainWindow", "Sql Data", 0));
        sqldata1->setText(QApplication::translate("MainWindow", "Sql Data1", 0));
        writedatabase->setText(QApplication::translate("MainWindow", "Write database in text", 0));
