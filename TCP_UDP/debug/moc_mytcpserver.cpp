...
QT_MOC_LITERAL(5, 37, 17), // "myServerConnected"
QT_MOC_LITERAL(6, 55, 4), // "port"
QT_MOC_LITERAL(7, 60, 20), // "myServerDisconnected"
QT_MOC_LITERAL(8, 81, 11), // "onConnected"
QT_MOC_LITERAL(9, 93, 14), // "onDisconnected"
QT_MOC_LITERAL(10, 108, 12) // "messageReady"

    },
    "MyTCPServer\0newMessage\0\0from\0message\0"
    "myServerConnected\0port\0myServerDisconnected\0"
    "onConnected\0onDisconnected\0messageReady"
};
...
void MyTCPServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->myServerConnected((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< quint16(*)>(_a[2]))); break;
        case 2: _t->myServerDisconnected(); break;
        case 3: _t->onConnected(); break;
        case 4: _t->onDisconnected(); break;
        case 5: _t->messageReady(); break;
        default: ;
        }
        ...
        {
            typedef void (MyTCPServer::*_t)(const QString & , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyTCPServer::newMessage)) {
                *result = 0;
            }
        }
        {
            typedef void (MyTCPServer::*_t)(const QString & , quint16 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyTCPServer::myServerConnected)) {
                *result = 1;
            }
        }
        {
            typedef void (MyTCPServer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyTCPServer::myServerDisconnected)) {
                *result = 2;
            }
        }
    }
...
// SIGNAL 0
void MyTCPServer::newMessage(const QString & _t1, const QString & _t2)
{
...
// SIGNAL 1
void MyTCPServer::myServerConnected(const QString & _t1, quint16 _t2)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
...
// SIGNAL 2
void MyTCPServer::myServerDisconnected()
{
