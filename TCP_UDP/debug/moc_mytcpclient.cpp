...
void MyTCPClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MyTCPClient::*_t)(const QString & , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyTCPClient::newMessage)) {
                *result = 0;
            }
        }
        {
            typedef void (MyTCPClient::*_t)(const QString & , quint16 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyTCPClient::myClientConnected)) {
                *result = 1;
            }
        }
        {
            typedef void (MyTCPClient::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyTCPClient::myClientDisconnected)) {
                *result = 2;
            }
        }
        {
            typedef void (MyTCPClient::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyTCPClient::connectionFailed)) {
                *result = 3;
            }
        }
    }
...
const QMetaObject MyTCPClient::staticMetaObject = {
    { &QTcpSocket::staticMetaObject, qt_meta_stringdata_MyTCPClient.data,
