...
void CustomItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->itemChanged((*reinterpret_cast< QPointF(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (CustomItem::*_t)(QPointF );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CustomItem::itemChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject CustomItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CustomItem.data,
      qt_meta_data_CustomItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CustomItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsRectItem"))
        return static_cast< QGraphicsRectItem*>(const_cast< CustomItem*>(this));
...
// SIGNAL 0
void CustomItem::itemChanged(QPointF _t1)
{
