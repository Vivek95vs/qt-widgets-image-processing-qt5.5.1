...
public:
    ...
    void setupUi(QDialog *operation_Img)
    {
        ...
        layoutWidget->setGeometry(QRect(10, 840, 1156, 41));
        ...
        saveRectitem = new QPushButton(operation_Img);
        saveRectitem->setObjectName(QStringLiteral("saveRectitem"));
        saveRectitem->setGeometry(QRect(720, 790, 75, 23));
        pushButton = new QPushButton(operation_Img);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(810, 790, 75, 23));
    ...
    void retranslateUi(QDialog *operation_Img)
    {
        ...
        saveRectitem->setText(QApplication::translate("operation_Img", "Save Rect", 0));
        pushButton->setText(QApplication::translate("operation_Img", "Save QImage", 0));
    } // retranslateUi
