...
vtkSmartPointer<vtkDICOMReader> RTStruct::dicomRead(QString dicomFolder)
{
    ...
    numSeries=dicomdir->GetNumberOfSeries();
...
void RTStruct::numser()
{
    if(numSeries>1)
    {
        qDebug()<<"Numberseries";
//        QMessageBox::warning(this,"Error","Problem in Dicom images");
        return;
    }
}
...
//    QString contours="2,3,4,5";
    ...
    QString patientname = ReqDatas.at(1);
    QString Patientid =ReqDatas.at(2);
    QString gender=ReqDatas.at(3);
    QString DOB=ReqDatas.at(4);
    QString age=ReqDatas.at(5);
    QString studyDes=ReqDatas.at(6);
    QString seriesDes=ReqDatas.at(7);
    QString Maufacture=ReqDatas.at(8);
    QString Manufacturemodel=ReqDatas.at(9);
    QString studyInstanceUID=ReqDatas.at(10);
    QString SeriesInstanceUID=ReqDatas.at(11);
    QString ReferenceframeInstance=ReqDatas.at(12);
    QString versionno=ReqDatas.at(13);
...
//    QString Manufacturemodel="YMGS234";
...
//    qDebug()<<"SOPInstance--6"<<SOPInstanceUIDList6;
    ...
    qDebug()<<"finalcontour"<<ContourFinalList;
        ...
        if(dataset->findOrCreateSequenceItem(DCM_ROIContourSequence,BS,C1).good()){
            ...
            for(int c=0;c<1;c++){
                if(BS->findOrCreateSequenceItem(DCM_ContourSequence,CS,c).good()){
                    ...
                    DcmItem *CIS;
                    for(int c1=0;c1<SOPInstanceUIDList.length();c1++){
...
void RTStruct::on_readtag_clicked()
{
...
//    std::cout<<"uids"<<StudyINSTANCEuid<<SeriesINSTANCEuid<<FrameReferenceuid;
    ...
    inputparameters(Contourpoints,SOPINSTANCEuid1,SOPINSTANCEuid2,SOPINSTANCEuid3, SOPINSTANCEuid4,SOPINSTANCEuid5,SOPINSTANCEuid6,reqDetails);
}
