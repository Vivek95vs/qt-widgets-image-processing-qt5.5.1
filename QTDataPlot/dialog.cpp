...
static const float maxX = 1000;
static const float minY = 0;
static const float maxY = 1000;
...
{
    writeXYDataToFile(&xData, &yData,"D:/pixelqq.csv");
...
{
    myDataFilePath = QFileDialog::getOpenFileName(this, tr("Open File"), "D://", "Comma Seperated (*.csv);;");
    initView();
}
...
void Dialog::setModelAndDataVectorsWithCSV(QVector<double> *xData, QVector<double> *yData, QStandardItemModel *model, QString datafilepath){
...
void Dialog::writeXYDataToFile(QVector<double> *xData, QVector<double> *yData, QString filepath){
...
void Dialog::backupDataFile(QString dataFile){
